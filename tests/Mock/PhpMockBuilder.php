...
class {$autloaderClass} extends \\Tests\\AsyncSockets\\Mock\\Autoloader {
    private static \$loader;

    /** @return \\Tests\\AsyncSockets\\Mock\\Autoloader */
...
MAGIC;
    ...
    function {$getMockerFunction}(\$function)
    {
        static \$ref;
        if (!\$ref) {
            \$ref = new \ReflectionProperty("\\\\Tests\\\\AsyncSockets\\\\Mock\\\\PhpFunctionMocker", 'mocks');
